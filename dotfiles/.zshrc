...
#ruby3.0
export PATH=$PATH:/usr/bin/ruby3.0
...
# ==================================[MORE ALIASES]=======================================
alias settarget='$HOME/.config/polybar/scripts/settarget.sh'
alias ll='ls -l'
alias la='ls -A'
alias l='ls -CF'
...
#source /usr/share/zsh-timer/timer.plugin.zsh
#source /usr/share/zsh-shift-select/zsh-shift-select.plugin.zsh
...
#mkdir 1recon 2scan 3access 4foothold 5clean 6results
#ls
